...
def get_data():
  account_file = open(r"Z:\Python\Goal tracker\accounts.txt","r")
...
neutral_image = PhotoImage(file=r"Z:\Python\Goal tracker\neutral.png")
happy_image = PhotoImage(file=r"Z:\Python\Goal tracker\happy.png")
sad_image = PhotoImage(file=r"Z:\Python\Goal tracker\sad.png")
